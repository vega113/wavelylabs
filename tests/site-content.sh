...
required=(
  ...
  "assets/slideslab-generation-status.jpg"
  "assets/slideslab-recent-generations-dashboard.jpg"
  "assets/slideslab-pricing-page.jpg"
  ...
  "assets/tube2web-import-content-modal.jpg"
  "assets/tube2web-creator-dashboard-grid.jpg"
  "assets/tube2web-public-generated-site.jpg"
  "assets/tube2web-pricing-page.jpg"
