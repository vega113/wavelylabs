...
required=(
  ...
  "alt=\"WavelyLabs logo\""
  "alt=\"WavelyLabs brand header featuring the AI product studio.\""
  "WavelyLabs"
  ...
  "Bulk import for YouTube, websites, local files, Google Drive content, and Instagram sources."
  "Document Library"
  "Folder library with sorting, file counts, sharing indicators, and chat entry points."
  "Folder Chat"
  ...
  "Primary support:"
  "Business location and jurisdiction: Tel Aviv, Israel"
  "Product support aliases:"
